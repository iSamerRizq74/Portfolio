                ...
                <p className="text-justify leading-relaxed w-full pr-0 xl:pr-8 text-[0.88rem] sm:text-[0.93rem] md:text-[1rem] tracking-tight">
                  <span className="block w-full text-gray-800 dark:text-gray-300">
                    {currentLanguage === 'FR'
                      ...
                      : currentLanguage === 'AR'
                        ? 'أصمّم مواقع ويب عصرية، سريعة الاستجابة، وسهلة الاستخدام بشغف ودقة. ألتزم بتطوير حلول رقمية مخصصة، مبتكرة وموثوقة، تحدث فرقًا حقيقيًا. أستمتع بتحويل الأفكار المعقدة إلى تطبيقات ويب قابلة للتطوير، مع التركيز على تقديم تجربة مستخدم سلسة، وواجهة مستخدم فعالة ومتميزة، وكتابة كود نظيف وسهل الصيانة.'

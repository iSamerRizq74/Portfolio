...
const Navbar = ({ darkMode, toggleDarkMode, currentLanguage, toggleLanguage }) => {
  ...
  const navItems = [
    {
      name: currentLanguage === 'FR' ? 'Accueil' : currentLanguage === 'AR' ? 'الرئيسية' : 'Home',
      href: "#hero",
      isHighlighted: false,
      isDarkBg: true
    },
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      href: "https://www.linkedin.com/in/isamerrizq74",
      label: "LinkedIn"
    },
    {
      icon: <FaFacebook className="w-5 h-5" />,
      href: "https://www.facebook.com/isamerrizq74",
      label: "Facebook"
    },
    {
      icon: <FaInstagram className="w-5 h-5" />,
      href: "https://www.instagram.com/isamerrizq74",
      label: "Instagram"
    },
    {
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-12">
            ...
            <div className="flex items-center space-x-2 md:hidden">
              ...
              {/* Language Toggle - Using the same implementation as desktop but visible on mobile */}
              <div className="relative z-[9999]" ref={languageMenuRef}>
                <button
                  onClick={() => setIsLanguageMenuOpen(!isLanguageMenuOpen)}
                  className="p-2 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 transition-colors"
                ...
                <div className="flex space-x-2 px-4">
                  {navItems.map((item) => (
                    <a
                      key={item.href}
                      href={item.href}
                      className={`px-3 py-1.5 text-xs font-medium text-white rounded transition-colors whitespace-nowrap flex-shrink-0 ${item.isDarkBg ? 'bg-gray-700/60 hover:bg-gray-700/80' : 'bg-gray-600/40 hover:bg-gray-600/60'}`}
              ...
              <div className="pt-1 border-t border-gray-700/50 mt-2">
                ...
                <div className="flex flex-col space-y-3 mt-3">
                  <button
                    ...
                    className="w-4/5 mx-auto flex items-center justify-center px-4 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-md transition-colors"
                  >
